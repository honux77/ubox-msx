...
S:Lmain.put_text$x$1_0$30({1}SC:U),B,1,2
S:Lmain.put_text$y$1_0$30({1}SC:U),B,1,3
S:Lmain.put_text$text$1_0$30({2}DG,SC:U),B,1,4
F:G$_putchar$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lmain._putchar$character$1_0$32({1}SC:S),B,1,2
F:G$my_isr$0_0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$main$0_0$0({2}DF,SV:S),C,0,0,0,0,0
S:Lmain.main$temp_counter$1_1$37({2}SI:S),R,0,0,[c,b]
