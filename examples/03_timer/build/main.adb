...
S:Lmain.put_text$x$1_0$33({1}SC:U),B,1,2
S:Lmain.put_text$y$1_0$33({1}SC:U),B,1,3
S:Lmain.put_text$text$1_0$33({2}DG,SC:U),B,1,4
F:G$my_isr$0_0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$main$0_0$0({2}DF,SV:S),C,0,0,0,0,0
S:Lmain.main$wait_tick$1_0$36({1}SC:U),R,0,0,[]
