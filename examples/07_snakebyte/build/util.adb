...
S:Lutil.put_text$x$1_0$56({1}SC:U),B,1,2
S:Lutil.put_text$y$1_0$56({1}SC:U),B,1,3
S:Lutil.put_text$text$1_0$56({2}DG,SC:U),B,1,4
F:G$RenderTile$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lutil.RenderTile$x$1_0$58({2}SI:S),B,1,2
S:Lutil.RenderTile$y$1_0$58({2}SI:S),B,1,4
S:Lutil.RenderTile$tileNum$1_0$58({2}SI:S),B,1,6
...
T:Futil$tm[({0}S:S$tm_sec$0_0$0({1}SC:U),Z,0,0)({1}S:S$tm_min$0_0$0({1}SC:U),Z,0,0)({2}S:S$tm_hour$0_0$0({1}SC:U),Z,0,0)({3}S:S$tm_mday$0_0$0({1}SC:U),Z,0,0)({4}S:S$tm_mon$0_0$0({1}SC:U),Z,0,0)({5}S:S$tm_year$0_0$0({2}SI:S),Z,0,0)({7}S:S$tm_wday$0_0$0({1}SC:U),Z,0,0)({8}S:S$tm_yday$0_0$0({2}SI:S),Z,0,0)({10}S:S$tm_isdst$0_0$0({1}SC:U),Z,0,0)({11}S:S$tm_hundredth$0_0$0({1}SC:U),Z,0,0)]
