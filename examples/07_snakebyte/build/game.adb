...
S:Lgame.InitGame$i$1_1$84({2}SI:S),R,0,0,[c,b]
S:Lgame.InitGame$j$1_1$84({2}SI:S),R,0,0,[e,d]
...
S:Lgame.MoveBody$node$1_0$89({2}DG,STSnakeNode:S),B,1,2
S:Lgame.MoveBody$xPos$1_0$89({2}SI:S),B,1,4
S:Lgame.MoveBody$yPos$1_0$89({2}SI:S),B,1,6
...
S:Lgame.GenerateNewFrog$randy$1_0$93({1}SC:S),R,0,0,[c]
S:Lgame.GenerateNewFrog$randx$1_0$93({1}SC:S),R,0,0,[e]
F:G$CheckWall$0_0$0({2}DF,SC:S),C,0,0,0,0,0
S:Lgame.CheckWall$player$1_0$95({2}DG,STSnakeNode:S),B,1,2
S:Lgame.CheckWall$result$1_0$96({1}SC:S),B,1,-1
S:Lgame.CheckWall$sloc0$0_1$0({1}SC:S),B,1,-1
F:G$ProcessLogic$0_0$0({2}DF,SV:S),Z,0,-4,0,0,0
S:Lgame.ProcessLogic$player$1_0$101({2}DG,STSnakeNode:S),B,1,2
S:Lgame.ProcessLogic$x_offset$2_1$104({1}SC:S),R,0,0,[c]
S:Lgame.ProcessLogic$y_offset$2_1$104({1}SC:S),R,0,0,[b]
S:Lgame.ProcessLogic$next_pos_x$3_2$109({1}SC:S),B,1,-8
S:Lgame.ProcessLogic$next_pos_y$3_2$109({1}SC:S),B,1,-7
S:Lgame.ProcessLogic$objectType$3_2$109({1}SC:S),R,0,0,[a]
S:Lgame.ProcessLogic$tail$4_3$111({2}DG,STSnakeNode:S),R,0,0,[e,d]
S:Lgame.ProcessLogic$new_node_x$4_4$113({2}SI:S),R,0,0,[]
S:Lgame.ProcessLogic$new_node_y$4_4$113({2}SI:S),R,0,0,[]
S:Lgame.ProcessLogic$newNode$4_5$114({2}DG,STSnakeNode:S),R,0,0,[c,b]
S:Lgame.ProcessLogic$sloc0$0_1$0({4}SL:S),B,1,-4
S:Lgame.ProcessLogic$sloc1$0_1$0({2}DG,STSnakeNode:S),B,1,-10
S:Lgame.ProcessLogic$sloc2$0_1$0({1}SC:S),B,1,-8
S:Lgame.ProcessLogic$sloc3$0_1$0({1}SC:S),B,1,-7
S:Lgame.ProcessLogic$sloc4$0_1$0({2}DD,SC:S),B,1,-6
S:Lgame.ProcessLogic$sloc5$0_1$0({2}DG,DG,STSnakeNode:S),B,1,-4
S:Lgame.ProcessLogic$sloc6$0_1$0({1}SC:S),B,1,-2
S:Lgame.ProcessLogic$sloc7$0_1$0({1}SC:S),B,1,-1
F:G$DrawObject$0_0$0({2}DF,SV:S),Z,0,-3,0,0,0
S:Lgame.DrawObject$c$1_0$115({1}SC:U),B,1,-3
S:Lgame.DrawObject$row$2_0$116({1}SC:U),B,1,-2
S:Lgame.DrawObject$col$4_0$118({1}SC:U),B,1,-1
