...
F:G$ProcessLogic$0_0$0({2}DF,SV:S),Z,0,-13,0,0,0
...
S:Lgame.ProcessLogic$pos_x$2_2$117({1}SC:S),B,1,-17
S:Lgame.ProcessLogic$pos_y$2_2$117({1}SC:S),B,1,-16
S:Lgame.ProcessLogic$next_pos_x$2_2$117({1}SC:S),B,1,-1
S:Lgame.ProcessLogic$next_pos_y$2_2$117({1}SC:S),B,1,-2
S:Lgame.ProcessLogic$objectType$2_2$117({1}SC:S),B,1,-13
S:Lgame.ProcessLogic$tail$2_2$117({2}DG,STSnakeNode:S),B,1,-12
S:Lgame.ProcessLogic$tail_x$2_3$119({2}SI:S),B,1,-8
S:Lgame.ProcessLogic$tail_y$2_3$119({2}SI:S),B,1,-6
S:Lgame.ProcessLogic$newNode$3_4$122({2}DG,STSnakeNode:S),R,0,0,[c,b]
S:Lgame.ProcessLogic$sloc0$0_1$0({1}SC:S),B,1,-2
S:Lgame.ProcessLogic$sloc1$0_1$0({2}SI:S),B,1,-4
S:Lgame.ProcessLogic$sloc2$0_1$0({4}SL:S),B,1,-6
S:Lgame.ProcessLogic$sloc3$0_1$0({2}DG,STSnakeNode:S),B,1,-19
S:Lgame.ProcessLogic$sloc4$0_1$0({1}SC:S),B,1,-17
S:Lgame.ProcessLogic$sloc5$0_1$0({1}SC:S),B,1,-16
S:Lgame.ProcessLogic$sloc6$0_1$0({1}SC:S),B,1,-1
S:Lgame.ProcessLogic$sloc7$0_1$0({1}SC:S),B,1,-2
S:Lgame.ProcessLogic$sloc8$0_1$0({2}DD,SC:S),B,1,-15
S:Lgame.ProcessLogic$sloc9$0_1$0({1}SC:S),B,1,-13
S:Lgame.ProcessLogic$sloc10$0_1$0({2}DG,STSnakeNode:S),B,1,-12
S:Lgame.ProcessLogic$sloc11$0_1$0({2}DG,DG,STSnakeNode:S),B,1,-10
S:Lgame.ProcessLogic$sloc12$0_1$0({2}DG,STSnakeNode:S),B,1,-4
S:Lgame.ProcessLogic$sloc13$0_1$0({2}DG,STSnakeNode:S),B,1,-4
S:Lgame.ProcessLogic$sloc14$0_1$0({2}SI:S),B,1,-8
S:Lgame.ProcessLogic$sloc15$0_1$0({2}SI:S),B,1,-6
S:Lgame.ProcessLogic$sloc16$0_1$0({2}SI:S),B,1,-4
S:Lgame.ProcessLogic$sloc17$0_1$0({2}SI:S),B,1,-2
