M:game
F:G$DrawScore$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lgame.DrawScore$num$1_0$81({2}SI:S),R,0,0,[c,b]
S:Lgame.DrawScore$i$2_0$82({2}SI:S),R,0,0,[e,d]
S:Lgame.DrawScore$sloc0$0_1$0({2}DD,SC:U),B,1,-2
F:G$DrawHighScore$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lgame.DrawHighScore$num$1_1$86({2}SI:S),R,0,0,[c,b]
S:Lgame.DrawHighScore$i$2_1$87({2}SI:S),R,0,0,[e,d]
S:Lgame.DrawHighScore$sloc0$0_1$0({2}DD,SC:U),B,1,-2
F:G$run_game$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$InitGame$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lgame.InitGame$i$1_1$92({2}SI:S),R,0,0,[c,b]
S:Lgame.InitGame$j$1_1$92({2}SI:S),R,0,0,[e,d]
...
S:Lgame.MoveBody$node$1_0$97({2}DG,STSnakeNode:S),B,1,2
S:Lgame.MoveBody$xPos$1_0$97({2}SI:S),B,1,4
S:Lgame.MoveBody$yPos$1_0$97({2}SI:S),B,1,6
...
S:Lgame.GenerateNewFrog$point$1_0$101({2}DG,STPoint:S),B,1,2
S:Lgame.GenerateNewFrog$sloc0$0_1$0({2}DG,SC:U),B,1,-2
F:G$CheckWall$0_0$0({2}DF,SC:S),C,0,0,0,0,0
S:Lgame.CheckWall$player$1_0$104({2}DG,STSnakeNode:S),B,1,2
S:Lgame.CheckWall$result$1_0$105({1}SC:S),B,1,-1
S:Lgame.CheckWall$sloc0$0_1$0({1}SC:S),B,1,-1
F:G$ProcessLogic$0_0$0({2}DF,SV:S),Z,0,-11,0,0,0
S:Lgame.ProcessLogic$player$1_0$110({2}DG,STSnakeNode:S),B,1,2
S:Lgame.ProcessLogic$x_offset$1_1$112({1}SC:S),R,0,0,[c]
S:Lgame.ProcessLogic$y_offset$1_1$112({1}SC:S),B,1,-2
S:Lgame.ProcessLogic$pos_x$2_2$118({1}SC:S),B,1,-17
S:Lgame.ProcessLogic$pos_y$2_2$118({1}SC:S),B,1,-16
S:Lgame.ProcessLogic$next_pos_x$2_2$118({1}SC:S),B,1,-1
S:Lgame.ProcessLogic$next_pos_y$2_2$118({1}SC:S),B,1,-2
S:Lgame.ProcessLogic$objectType$2_2$118({1}SC:S),B,1,-13
S:Lgame.ProcessLogic$tail$2_2$118({2}DG,STSnakeNode:S),B,1,-12
S:Lgame.ProcessLogic$tail_x$2_3$120({2}SI:S),B,1,-8
S:Lgame.ProcessLogic$tail_y$2_3$120({2}SI:S),B,1,-6
S:Lgame.ProcessLogic$newNode$3_4$123({2}DG,STSnakeNode:S),R,0,0,[c,b]
S:Lgame.ProcessLogic$sloc0$0_1$0({1}SC:S),B,1,-2
S:Lgame.ProcessLogic$sloc1$0_1$0({4}SL:S),B,1,-6
S:Lgame.ProcessLogic$sloc2$0_1$0({2}DG,STSnakeNode:S),B,1,-19
S:Lgame.ProcessLogic$sloc3$0_1$0({1}SC:S),B,1,-17
S:Lgame.ProcessLogic$sloc4$0_1$0({1}SC:S),B,1,-16
S:Lgame.ProcessLogic$sloc5$0_1$0({1}SC:S),B,1,-1
S:Lgame.ProcessLogic$sloc6$0_1$0({1}SC:S),B,1,-2
S:Lgame.ProcessLogic$sloc7$0_1$0({2}DD,SC:S),B,1,-15
S:Lgame.ProcessLogic$sloc8$0_1$0({1}SC:S),B,1,-13
S:Lgame.ProcessLogic$sloc9$0_1$0({2}DG,STSnakeNode:S),B,1,-12
S:Lgame.ProcessLogic$sloc10$0_1$0({2}DG,DG,STSnakeNode:S),B,1,-10
S:Lgame.ProcessLogic$sloc11$0_1$0({2}DG,STSnakeNode:S),B,1,-4
S:Lgame.ProcessLogic$sloc12$0_1$0({2}DG,STSnakeNode:S),B,1,-4
S:Lgame.ProcessLogic$sloc13$0_1$0({2}SI:S),B,1,-8
S:Lgame.ProcessLogic$sloc14$0_1$0({2}SI:S),B,1,-6
S:Lgame.ProcessLogic$sloc15$0_1$0({2}SI:S),B,1,-4
S:Lgame.ProcessLogic$sloc16$0_1$0({2}SI:S),B,1,-2
F:G$DrawBackground$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lgame.DrawBackground$index$2_0$125({2}SI:S),R,0,0,[c,b]
S:Lgame.DrawBackground$index$2_0$126({2}SI:S),R,0,0,[c,b]
S:Lgame.DrawBackground$index$2_0$127({2}SI:S),R,0,0,[c,b]
S:Lgame.DrawBackground$index$2_0$128({2}SI:S),R,0,0,[c,b]
T:Fgame$Point[({0}S:S$x$0_0$0({1}SC:U),Z,0,0)({1}S:S$y$0_0$0({1}SC:U),Z,0,0)]
...
S:G$g_high_score$0_0$0({2}SI:S),E,0,0
S:G$g_score_text$0_0$0({10}DA10d,SC:U),E,0,0
S:G$g_high_score_text$0_0$0({9}DA9d,SC:U),E,0,0
...
S:G$g_frog$0_0$0({2}STPoint:S),E,0,0
