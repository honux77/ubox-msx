M:game
F:G$score2text$0_0$0({2}DF,SV:S),C,0,0,0,0,0
S:Lgame.score2text$num$1_0$81({2}SI:S),B,1,2
S:Lgame.score2text$i$1_0$82({2}SI:S),R,0,0,[c,b]
S:Lgame.score2text$sloc0$0_1$0({2}DD,SC:U),B,1,-2
F:G$run_game$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$drawScore$0_0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$InitGame$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lgame.InitGame$i$1_1$89({2}SI:S),R,0,0,[c,b]
S:Lgame.InitGame$j$1_1$89({2}SI:S),R,0,0,[e,d]
...
S:Lgame.MoveBody$node$1_0$94({2}DG,STSnakeNode:S),B,1,2
S:Lgame.MoveBody$xPos$1_0$94({2}SI:S),B,1,4
S:Lgame.MoveBody$yPos$1_0$94({2}SI:S),B,1,6
...
S:Lgame.GenerateNewFrog$point$1_0$98({2}DG,STPoint:S),B,1,2
S:Lgame.GenerateNewFrog$sloc0$0_1$0({2}DG,SC:U),B,1,-2
F:G$CheckWall$0_0$0({2}DF,SC:S),C,0,0,0,0,0
S:Lgame.CheckWall$player$1_0$101({2}DG,STSnakeNode:S),B,1,2
S:Lgame.CheckWall$result$1_0$102({1}SC:S),B,1,-1
S:Lgame.CheckWall$sloc0$0_1$0({1}SC:S),B,1,-1
F:G$ProcessLogic$0_0$0({2}DF,SV:S),Z,0,-13,0,0,0
S:Lgame.ProcessLogic$player$1_0$107({2}DG,STSnakeNode:S),B,1,2
S:Lgame.ProcessLogic$x_offset$1_1$109({1}SC:S),R,0,0,[c]
S:Lgame.ProcessLogic$y_offset$1_1$109({1}SC:S),B,1,-2
S:Lgame.ProcessLogic$pos_x$2_2$114({1}SC:S),B,1,-13
S:Lgame.ProcessLogic$pos_y$2_2$114({1}SC:S),B,1,-12
S:Lgame.ProcessLogic$next_pos_x$2_2$114({1}SC:S),B,1,-1
S:Lgame.ProcessLogic$next_pos_y$2_2$114({1}SC:S),B,1,-2
S:Lgame.ProcessLogic$objectType$2_2$114({1}SC:S),B,1,-11
S:Lgame.ProcessLogic$tail$2_2$114({2}DG,STSnakeNode:S),R,0,0,[e,d]
S:Lgame.ProcessLogic$tail_x$2_3$116({2}SI:S),B,1,-8
S:Lgame.ProcessLogic$tail_y$2_3$116({2}SI:S),B,1,-6
S:Lgame.ProcessLogic$newNode$3_4$119({2}DG,STSnakeNode:S),B,1,-15
...
S:Lgame.ProcessLogic$sloc3$0_1$0({2}DG,STSnakeNode:S),B,1,-15
S:Lgame.ProcessLogic$sloc4$0_1$0({1}SC:S),B,1,-13
S:Lgame.ProcessLogic$sloc5$0_1$0({1}SC:S),B,1,-12
S:Lgame.ProcessLogic$sloc6$0_1$0({1}SC:S),B,1,-1
S:Lgame.ProcessLogic$sloc7$0_1$0({1}SC:S),B,1,-2
S:Lgame.ProcessLogic$sloc8$0_1$0({1}SC:S),B,1,-11
S:Lgame.ProcessLogic$sloc9$0_1$0({2}DG,DG,STSnakeNode:S),B,1,-10
S:Lgame.ProcessLogic$sloc10$0_1$0({2}SI:S),B,1,-8
S:Lgame.ProcessLogic$sloc11$0_1$0({2}SI:S),B,1,-6
S:Lgame.ProcessLogic$sloc12$0_1$0({2}SI:S),B,1,-4
S:Lgame.ProcessLogic$sloc13$0_1$0({2}SI:S),B,1,-2
S:Lgame.ProcessLogic$sloc14$0_1$0({2}DG,STSnakeNode:S),B,1,-15
S:Lgame.ProcessLogic$sloc15$0_1$0({2}SI:S),B,1,-10
...
S:G$g_score_text$0_0$0({4}DA4d,SC:U),E,0,0
...
S:G$score2text$0_0$0({2}DF,SV:S),C,0,0
S:G$drawScore$0_0$0({2}DF,SV:S),C,0,0
