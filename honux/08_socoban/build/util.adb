...
S:Lutil.put_text$x$1_0$24({1}SC:U),B,1,2
S:Lutil.put_text$y$1_0$24({1}SC:U),B,1,3
S:Lutil.put_text$text$1_0$24({2}DG,SC:U),B,1,4
F:G$RenderTile$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lutil.RenderTile$x$1_0$26({2}SI:S),B,1,2
S:Lutil.RenderTile$y$1_0$26({2}SI:S),B,1,4
S:Lutil.RenderTile$tileNum$1_0$26({2}SI:S),B,1,6
